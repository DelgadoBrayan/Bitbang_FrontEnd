...
export const Register = () => {
    ...
    const onSubmit = handleSubmit(async (data) => {
        try {
            const response = await axios.post('https://bitbang-backend.onrender.com/api/user', {
                nameUser: data.name,
    ...
    return (
        <section className="bg-gradient-to-r from-slate-950 to-slate-900 dark:bg-gray-900  min-h-screen">
                ...
                <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" onSubmit={onSubmit}>
                            ...
                            <button
                                type="submit"
                                className="border-2 w-full bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none text-gray-800 text-xl bg-gradient-to-r from-indigo-500 to-blue-500 focus:ring-primary-300 font-medium rounded-lg px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                            >
                                Create an account
                            </button>
